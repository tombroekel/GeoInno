...
The package requires the packages **igraph**, **tidyverse**, **widyr**,**future**, **future.apply**, **data.table**, **netdist** to be installed. The package **netdist** can be found here: https://github.com/alan-turing-institute/network-comparison/ 
